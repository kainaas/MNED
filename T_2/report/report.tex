...
\begin{document}
    ...
    \end{align}
    Resolvendo a inequação, verificamos que $|a| \in (0, 2\sqrt{2})$. Defina $z_j = ia_j$, $j=1,2$. Temos $|a_j| = |h \cdot \Im(\lambda_j)| \le h$. Logo, $|z_j| \le h$. Com isso, para o método ser absolutamente estável, devemos ter $h \in (0, 2\sqrt{2})$. 
